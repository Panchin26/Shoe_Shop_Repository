...
import com.example.shoe_shop.ui.viewmodel.EmailVerificationViewModel
...
fun EmailVerificationScreen(
    ...
    LaunchedEffect(verificationState) {
        when (verificationState) {
            is com.example.shoe_shop.ui.viewmodel.VerificationState.Success -> {
                onVerificationSuccess()
                viewModel.resetState()
            }
            is com.example.shoe_shop.ui.viewmodel.VerificationState.Error -> {
                val errorMessage = (verificationState as com.example.shoe_shop.ui.viewmodel.VerificationState.Error).message
